                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="labs">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="Linux 目录结构及文件基本操作">Linux 目录结构及文件基本操作</div>
                                <div class="pull-right lab-item-ctrl">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="文件系统操作与磁盘管理">文件系统操作与磁盘管理</div>
                                <div class="pull-right lab-item-ctrl">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="Linux下的帮助命令">Linux下的帮助命令</div>
                                <div class="pull-right lab-item-ctrl">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="Linux任务计划crontab">Linux任务计划crontab</div>
                                <div class="pull-right lab-item-ctrl">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="命令执行顺序控制与管道">命令执行顺序控制与管道</div>
                                <div class="pull-right lab-item-ctrl">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="Linux下软件安装">Linux下软件安装</div>
                                <div class="pull-right lab-item-ctrl">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="Linux 进程概念">Linux 进程概念</div>
                                <div class="pull-right lab-item-ctrl">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="Linux 进程管理">Linux 进程管理</div>
                                <div class="pull-right lab-item-ctrl">
                            ...
                            <div class="lab-item ">
                                ...
                                <div class="lab-item-title" data-toggle="tooltip" data-placement="bottom"
                                    title="Linux 日志系统">Linux 日志系统</div>
                                <div class="pull-right lab-item-ctrl">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a type="button" class="submit-question btn btn-primary" href="/vip" target="_blank"
                        style="background:#FFFFFF;color:#00CC99;border:none;float:left;padding-left:0;">
                            <!-- <img src="../img/senior-vip-icon.png" alt="">  -->
                     加入高级会员获得助教答疑    </a>
                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div style="color:#84B61A; font-size:14px; font-weight:bold;">激活后可不限次数学习本课。<a href="/faq#shiyandou"
                            style="font-weight:normal;" target="_blank">如何获得实验豆？</a></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-primary paid-method" type="button"
                                style="background:none; color:#0c9">选择支付方式</button>
                        </div>
                    </div>
                </div>
            </div>
